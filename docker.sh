...
install() {
    ...
    if [[ ! -f .env ]]; then
        ...
        curl -fsSL https://raw.githubusercontent.com/engrsam/azurarelay/master/.env -o .env
    fi

    if [[ ! -f docker-compose.yml ]]; then
        echo "Retrieving default docker-compose.yml file..."
        curl -fsSL https://raw.githubusercontent.com/engrsam/azurarelay/master/docker-compose.sample.yml -o docker-compose.yml
    fi
    ...
    docker cp relay:/var/azurarelay/www_tmp/azurarelay.env ./azurarelay.env
...
#
update() {
    curl -fsSL https://raw.githubusercontent.com/engrsam/azurarelay/master/docker-compose.sample.yml -o docker-compose.new.yml
...
#
update-self() {
    curl -fsSL https://raw.githubusercontent.com/engrsam/azurarelay/master/docker.sh -o docker.sh
    chmod a+x docker.sh
